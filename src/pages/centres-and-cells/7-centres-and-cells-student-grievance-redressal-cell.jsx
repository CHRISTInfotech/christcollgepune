...
import grievanceFormPdf from '../../assets/studentlife/cells/Christ college__StudentGrievance_form(1).pdf';
import grievanceExamFormPdf from '../../assets/studentlife/cells/Christ college__internal exam StudentGrievance_form(3).pdf';
import membersPdf from '../../assets/studentlife/cells/GRIEVANCE REDRESSAL CELL(1).pdf';

const DOCUMENTS = [
  { name: 'Student Grievance Redressal Form', file: grievanceFormPdf },
  { name: 'Student Grievance Redressal (Exam Form)', file: grievanceExamFormPdf },
  { name: 'Members', file: membersPdf },
];
