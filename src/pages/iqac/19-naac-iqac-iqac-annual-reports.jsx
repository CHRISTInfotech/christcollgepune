  ...
  return (
    <>
      <Seo
        ...
        description="Annual Reports of Christ College, Pune, summarising the college's academic, co-curricular and administrative activities for each academic year."
      />
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-16">
        <div className="max-w-3xl">
          <p className="text-cc-text-body">
            ...
            academic, co-curricular, extension and administrative activities. Reports for recent
            academic years are listed below; earlier years&rsquo; reports are also on file with the
            college.
          </p>
